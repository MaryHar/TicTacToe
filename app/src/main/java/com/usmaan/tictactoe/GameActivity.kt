...
class GameActivity : AppCompatActivity() {
    ...
    private lateinit var continueTheGameButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        continueTheGameButton = findViewById(R.id.continue_the_game_button)
        ...
        continueTheGameButton.setOnClickListener {
            continueTheGameButton.visibility = View.GONE
    ...
    private fun onBoxClicked(box: TextView, position: Position) {
        if (box.text.isEmpty()) {
            ...
            if (winningLine != null) {
                ...
                continueTheGameButton.visibility = View.VISIBLE
